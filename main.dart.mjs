...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _198: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _199: x0 => x0.remove(),
      ...
      _722: () => globalThis.window.flutterWebRenderer,
      _730: x0 => x0.console,
      ...
      _1322: () => globalThis.window.__flutterState,
      _1323: x0 => { globalThis.window.__flutterState = x0 },
      _1326: (x0,x1) => x0.canShare(x1),
      _1327: (x0,x1) => x0.share(x1),
      _1330: (x0,x1) => ({files: x0,text: x1}),
      _1332: x0 => ({files: x0}),
      _1334: x0 => ({text: x0}),
      ...
      _1394: s => JSON.stringify(s),
      _1395: s => printToConsole(s),
      ...
      _1407: Object.is,
      _1408: o => o instanceof Array,
      _1409: (a, i) => a.push(i),
      _1413: a => a.pop(),
      _1414: (a, i) => a.splice(i, 1),
      _1415: (a, s) => a.join(s),
      _1416: (a, s, e) => a.slice(s, e),
      _1419: a => a.length,
      _1421: (a, i) => a[i],
      _1422: (a, i, v) => a[i] = v,
      _1424: o => {
      ...
      _1425: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1427: o => o instanceof Uint8Array,
      _1428: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1429: o => o instanceof Int8Array,
      _1430: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1431: o => o instanceof Uint8ClampedArray,
      _1432: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1433: o => o instanceof Uint16Array,
      _1434: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1435: o => o instanceof Int16Array,
      _1436: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1437: o => o instanceof Uint32Array,
      _1438: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1439: o => o instanceof Int32Array,
      _1440: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1442: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1443: o => o instanceof Float32Array,
      _1444: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1445: o => o instanceof Float64Array,
      _1446: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1447: (t, s) => t.set(s),
      _1448: l => new DataView(new ArrayBuffer(l)),
      _1449: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1451: o => o.buffer,
      _1452: o => o.byteOffset,
      _1453: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1454: (b, o) => new DataView(b, o),
      _1455: (b, o, l) => new DataView(b, o, l),
      _1456: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1457: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1458: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1459: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1460: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1461: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1462: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1463: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1464: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1465: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1466: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1467: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1470: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1471: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1472: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1473: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1474: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1475: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1477: () => globalThis.performance,
      _1478: () => globalThis.JSON,
      _1479: x0 => x0.measure,
      _1480: x0 => x0.mark,
      _1481: x0 => x0.clearMeasures,
      _1482: x0 => x0.clearMarks,
      _1483: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1484: (x0,x1,x2) => x0.mark(x1,x2),
      _1485: x0 => x0.clearMeasures(),
      _1486: x0 => x0.clearMarks(),
      _1487: (x0,x1) => x0.parse(x1),
      _1488: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1489: (handle) => clearTimeout(handle),
      _1490: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1491: (handle) => clearInterval(handle),
      _1492: (c) =>
      ...
      _1495: (x0,x1) => x0.exec(x1),
      _1496: (x0,x1) => x0.test(x1),
      _1497: x0 => x0.pop(),
      _1499: o => o === undefined,
      _1501: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1503: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1504: o => o instanceof RegExp,
      _1505: (l, r) => l === r,
      _1506: o => o,
      _1507: o => o,
      _1508: o => o,
      ...
      _1527: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1527(f,arguments.length,x0,x1) }),
      _1528: o => {
      ...
      _1554: (o, p) => p in o,
      _1555: (o, p) => o[p],
      _1582: () => new AbortController(),
      _1583: x0 => x0.abort(),
      _1584: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1585: (x0,x1) => globalThis.fetch(x0,x1),
      _1586: (x0,x1) => x0.get(x1),
      _1587: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1587(f,arguments.length,x0,x1,x2) }),
      _1588: (x0,x1) => x0.forEach(x1),
      _1589: x0 => x0.getReader(),
      _1590: x0 => x0.cancel(),
      _1591: x0 => x0.read(),
      _1592: x0 => x0.random(),
      _1593: (x0,x1) => x0.getRandomValues(x1),
      _1594: () => globalThis.crypto,
      _1595: () => globalThis.Math,
      ...
      _1613: (d, precision) => d.toPrecision(precision),
      _3492: () => globalThis.window,
      _3554: x0 => x0.navigator,
